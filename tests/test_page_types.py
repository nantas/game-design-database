...
def test_github_awesome_repo_url_is_entry_page() -> None:
    url = "https://github.com/KenneyNL/awesome-gamedev"
...
def test_regular_github_repo_url_defaults_to_article() -> None:
